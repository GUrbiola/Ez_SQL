...
{
    public delegate void SelectedColor(Color color);
	public class ColorPickerCombobox : DropdownContainerControl<Color>
	{
        ...
        public event SelectedColor OnSelectedColor;
        public string HtmlSelectedItem
        {
            get 
            {
                ...
                {
                    int Red, Green, Blue;
                    Red = (int)SelectedItem.R;
                    Green = (int)SelectedItem.G;
                    Blue = (int)SelectedItem.B;
		...
		public ColorPickerCombobox()
		{
			...
			if (m_colorPicker == null)
			{
                ...
                m_colorPicker.IsVisibleOpacitySlider(false);
