...
namespace Ez_SQL.ConnectionBarNodes
{
	...
	public class RootConxNode : AddressBarExt.IAddressNode
	{
        ...
        public Icon Icon
        {
        	get { return Globals.MakeIcon(Properties.Resources.ConxPlug, 22, false); }
        }
        ...
        public RootConxNode(string DisplayText)
        {
        	GenerateRootNode();
            //fill in the relevant details
			szDisplayName = DisplayText;
        ...
        {
        	return new RootConxNode(szDisplayName);
        }
